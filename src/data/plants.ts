...
export const PLANT_SPECIES: PlantSpecies[] = [
  {
    ...
    difficulty: 'easy',
    idealMoisture: 'slightly-dry',
    light: 'bright-indirect',
    waterHardnessTolerance: 'tolerant',
    coldWaterSensitive: true,
    wateringFrequencyDays: { min: 7, max: 14 },
  ...
  },
  {
    ...
    idealMoisture: 'slightly-dry',
    light: 'low',
    waterHardnessTolerance: 'any',
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 7, max: 14 },
    temperatureRange: { min: 15, max: 30 },
    safeCats: false,
    safeDogs: false,
  ...
  },
  {
    ...
    idealMoisture: 'moist',
    light: 'bright-indirect',
    waterHardnessTolerance: 'soft-preferred',
    coldWaterSensitive: true,
    wateringFrequencyDays: { min: 7, max: 10 },
    temperatureRange: { min: 16, max: 27 },
    safeCats: false,
    safeDogs: false,
    category: 'ornamental',
    subcategory: 'tree',
  },
  {
    ...
    waterHardnessTolerance: 'soft-preferred',
    coldWaterSensitive: true,
    wateringFrequencyDays: { min: 5, max: 10 },
    temperatureRange: { min: 16, max: 27 },
    safeCats: false,
    safeDogs: false,
    category: 'ornamental',
  ...
  },
  {
    ...
    waterHardnessTolerance: 'any',
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 14, max: 28 },
    temperatureRange: { min: 10, max: 32 },
    safeCats: false,
    safeDogs: false,
    category: 'ornamental',
  ...
  {
    id: 'calathea',
    scientificName: 'Calathea ornata / medallion',
    difficulty: 'hard',
    idealMoisture: 'moist',
    light: 'indirect',
    waterHardnessTolerance: 'soft-only',
    coldWaterSensitive: true,
    wateringFrequencyDays: { min: 5, max: 9 },
  ...
  },
  {
    ...
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 7, max: 14 },
    temperatureRange: { min: 13, max: 27 },
    safeCats: true,
    safeDogs: true,
    category: 'ornamental',
    subcategory: 'tropical',
  },
  {
    ...
    waterHardnessTolerance: 'any',
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 14, max: 21 },
  ...
  },
  {
    ...
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 14, max: 21 },
    temperatureRange: { min: 10, max: 27 },
    safeCats: false,
    safeDogs: false,
    category: 'ornamental',
    subcategory: 'succulent',
  },
  {
    ...
    waterHardnessTolerance: 'soft-preferred',
    coldWaterSensitive: true,
    wateringFrequencyDays: { min: 10, max: 21 },
  ...
  // ─── Culinary herbs ──────────────────────────────────────────────────────────
  {
    ...
    waterHardnessTolerance: 'any',
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 2, max: 3 },
    temperatureRange: { min: 18, max: 30 },
    safeCats: true,
    safeDogs: true,
    category: 'culinary',
  ...
  },
  {
    ...
    waterHardnessTolerance: 'any',
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 2, max: 4 },
    temperatureRange: { min: 10, max: 25 },
    safeCats: false,
    safeDogs: false,
    category: 'culinary',
  ...
  },
  {
    ...
    waterHardnessTolerance: 'any',
    coldWaterSensitive: false,
    wateringFrequencyDays: { min: 3, max: 5 },
    temperatureRange: { min: 10, max: 25 },
    safeCats: true,
    safeDogs: true,
    category: 'culinary',
